...
DATABASEUSER=usr_glpi_teste

# Senha do usuario da Base de Dados
DATABASEPASSWORD='KA97h7dM6xzQu6'
...
mysqldump -u $DATABASEUSER $(if [ $DATABASEPASSWORD != NULL ] ; then echo "-p$DATABASEPASSWORD"; fi) $DATABASE > $BKPDIR/glpi_alece__$DATE.sql
